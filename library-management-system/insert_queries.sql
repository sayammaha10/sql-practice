...
-- Insert sample data into the issued_status table
...
-- Insert sample data into the return_status table
...
-- Insert additional books issued recently
INSERT INTO issued_status(issued_id, issued_member_id, issued_book_name, issued_date, issued_book_isbn, issued_emp_id)
VALUES
...
-- Add book quality column to return_status
